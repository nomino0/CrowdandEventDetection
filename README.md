...
- <img src="https://github.com/pytorch/pytorch/raw/master/docs/source/_static/img/pytorch-logo-dark.png " width=50% height=50%>

   A popular open-source machine learning library for Python that is used for building and training neural network models
    
- <img src="https://www.comet.com/docs/v2/img/icons/integrations/yolov5-logo.svg" width=40% height=40% >

    A real-time object detection algorithm implemented in Python using the Anaconda command prompt.
 
- 
  <img src="https://miro.medium.com/max/800/0*YjRQsNMVzKCvhBFX.png" width=60% height=60% >
...
- 
  <img src="https://behind-the-scenes.net/wp-content/uploads/raspberry-pi-wi-fi-1024x512.jpg" width=40% height=40% >
